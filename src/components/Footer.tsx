  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16">
        ...
        {/* Logo centré grand */}
        <div
          className="flex flex-col items-center mb-16 pb-16"
          style={{ borderBottom: "1px solid #1B3055" }}
        >
          <LogoFull markHeight={120} layout="col" />
          <p
            className="text-sm leading-relaxed text-center mt-8 max-w-sm"
            style={{ color: "#8AABD4", fontWeight: 300 }}
          >
            Spécialiste de l&apos;import de véhicules premium européens.
            Sélection rigoureuse, transparence totale, accompagnement complet.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              {[
                ...
                <li key={link.href}>
                  <Link
                    ...
                    onMouseLeave={(e) => (e.currentTarget.style.color = "#8AABD4")}
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm" style={{ color: "#8AABD4", fontWeight: 300 }}>
