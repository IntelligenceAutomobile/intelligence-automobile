...
export default async function HomePage() {
  const [{ t }, derniersVehicules] = await Promise.all([
    getTranslations(),
    ...
    <>
      ...
      <main style={{ backgroundColor: "#070F1E", color: "#F0F5FF", overflowX: "hidden" }}>
        ...
        <section className="ia-service-block" style={{ borderTop: "1px solid #1B3055", backgroundColor: "#040B16" }}>
          <Link href="/recherche-2" className="flex flex-col lg:flex-row" style={{ minHeight: "70vh", textDecoration: "none", cursor: "pointer" }}>
            <div className="w-full lg:w-[58%]" style={{ position: "relative", minHeight: "380px", overflow: "hidden" }}>
              <img className="ia-service-img" src="https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=1200&q=85" alt="" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "center" }} />
        ...
        {/* SERVICE 02 — Revente */}
        <section className="ia-service-block" style={{ borderTop: "1px solid #1B3055", backgroundColor: "#040B16" }}>
          <Link href="/aide-vente-2" className="flex flex-col-reverse lg:flex-row" style={{ minHeight: "70vh", textDecoration: "none", cursor: "pointer" }}>
            <div className="w-full lg:w-[42%]" style={{ position: "relative", display: "flex", flexDirection: "column", justifyContent: "center", padding: "6vh 5vw", overflow: "hidden" }}>
            ...
            <div className="w-full lg:w-[58%]" style={{ position: "relative", minHeight: "380px", overflow: "hidden" }}>
              <img className="ia-service-img" src="https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?auto=format&fit=crop&w=1200&q=85" alt="" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "center" }} />
        ...
        <section className="ia-service-block" style={{ borderTop: "1px solid #1B3055", backgroundColor: "#040B16" }}>
          <Link href="/convoyage-2" className="flex flex-col lg:flex-row" style={{ minHeight: "70vh", textDecoration: "none", cursor: "pointer" }}>
            <div className="w-full lg:w-[58%]" style={{ position: "relative", minHeight: "380px", overflow: "hidden" }}>
              <img className="ia-service-img" src="https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?auto=format&fit=crop&w=1200&q=85" alt="" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "center" }} />
              <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to right, transparent 55%, #040B16 100%)" }} />
              <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, #040B16 0%, transparent 25%)" }} />
            </div>
            <div className="w-full lg:w-[42%]" style={{ position: "relative", display: "flex", flexDirection: "column", justifyContent: "center", padding: "6vh 5vw", overflow: "hidden" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 0 }}>
                {t.home.processSteps.map((s) => (
                  <div key={s.n} style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", padding: "0 3vw" }}>
                    <div style={{ width: "36px", height: "36px", borderRadius: "50%", border: "1px solid #1B3055", backgroundColor: "#070F1E", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "10px", fontWeight: 600, letterSpacing: "0.1em", color: "#6B9FEE", marginBottom: "2.4rem", flexShrink: 0, position: "relative", zIndex: 1 }}>
                      {s.n}
                    </div>
          ...
          <section style={{ borderTop: "1px solid #1B3055", backgroundColor: "#070F1E" }}>
            <div style={{ maxWidth: "1400px", margin: "0 auto", padding: "10vh 5vw 4vh" }}>
              <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: "6vh" }}>
                ...
                <Link href="/vehicules-2" style={{ fontSize: "10px", letterSpacing: "0.3em", textTransform: "uppercase", color: "#6B9FEE", display: "none" }} className="md:block">
                  {t.home.stockLink}
                </Link>
              </div>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "1px", backgroundColor: "#1B3055" }}>
              {derniersVehicules.map((v) => {
                ...
                return (
                  <Link href={`/vehicules/${v.id}`} key={v.id} className="ia-card" style={{ display: "block", overflow: "hidden", backgroundColor: "#070F1E", textDecoration: "none" }}>
                    ...
                    <div style={{ padding: "28px 32px 36px" }}>
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "8px" }}>
                        <span style={{ fontSize: "10px", letterSpacing: "0.4em", textTransform: "uppercase", fontWeight: 700, color: "#6B9FEE" }}>{v.make}</span>
                        <span style={{ fontSize: "10px", letterSpacing: "0.08em", color: "#4A6A9A" }}>{v.year} · {v.mileage.toLocaleString("fr-FR")} km</span>
                      </div>
                      <h3 style={{ fontSize: "1.25rem", fontWeight: 900, textTransform: "uppercase", letterSpacing: "-0.01em", color: "#F0F5FF", marginBottom: "20px", lineHeight: 1.1 }}>{v.model}</h3>
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", borderTop: "1px solid #1B3055", paddingTop: "18px" }}>
                        <span style={{ fontSize: "1.5rem", fontWeight: 900, letterSpacing: "-0.02em", color: "#F0F5FF" }}>{v.price.toLocaleString("fr-FR")} €</span>
                        <span style={{ fontSize: "10px", letterSpacing: "0.3em", textTransform: "uppercase", color: "#6B9FEE" }}>{t.home.vehicleDetail}</span>
                      </div>
                    </div>
                  </Link>
                );
            ...
            <div style={{ textAlign: "center", padding: "36px", display: "block" }} className="md:hidden">
              <Link href="/vehicules-2" style={{ fontSize: "11px", letterSpacing: "0.3em", textTransform: "uppercase", color: "#6B9FEE" }}>
                {t.home.stockLink}
              </Link>
            </div>
          </section>
