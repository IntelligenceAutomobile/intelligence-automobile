...
export default function PrintToolbar() {
  ...
  return (
    <div className="dossier-no-print flex items-center justify-center gap-3 py-4 sticky top-0 z-10" style={{ backgroundColor: T.bg, borderBottom: `1px solid ${T.border}` }}>
