export const fr = {
  ...
  home: {
    ...
    service01Desc: "Chaque véhicule soigneusement sélectionné auprès de partenaires européens, contrôlé, documenté, prêt à livrer.",
    service02Title: ["Recherche", "personnalisée"],
    service02Desc: "Dites-nous ce que vous recherchez. Nous vous soumettons une sélection validée, sans engagement.",
    service03Title: ["Revente", "sur mesure"],
    service03Desc: "Estimation au prix du marché réel, diffusion ciblée, transaction sécurisée. Vous vendez mieux, sans vous en occuper.",
    service04Title: ["Transport", "& Livraison"],
    service04Desc: "Conducteur professionnel, couverture assurance complète, photos avant et après. Nous acheminons votre véhicule en toute sécurité.",
    service05Title: ["Notre", "méthode"],
    service05Desc: "L'import premium, simplement. Nous trouvons le bon véhicule, vérifions l'essentiel et sécurisons chaque étape. Notre travail, c'est votre tranquillité d'esprit.",
    service06Title: ["Nos", "services"],
    service06Desc: "De la garantie à la carte grise définitive, nous gérons l'ensemble des démarches qui sécurisent et simplifient votre acquisition. Vous conduisez, nous nous occupons du reste.",
