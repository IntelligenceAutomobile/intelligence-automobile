export const fr = {
  ...
  method: {
    ...
    steps: [
      { num: "01", value: "Écoute", title: "Comprendre le projet", description: "Acheter, revendre, faire venir un véhicule d'Europe : tout part du même endroit, une conversation où nous écoutons avant de proposer.\nVotre usage, votre budget, votre échéance. Le reste en découle.", tagline: "Le bon conseil commence par la bonne question." },
      { num: "02", value: "Intelligence", title: "Conseiller en connaissance de cause", description: "Cotes européennes, historiques, volumes de vente, délais réels : nous croisons les sources avant d'avancer un prix ou une date.\nLes outils éclairent, l'expérience tranche. C'est ce mélange qui donne son nom à la maison.", tagline: "La donnée éclaire, le métier décide." },
      { num: "03", value: "Exigence", title: "Vérifier avant d'engager", description: "Un véhicule que nous vendons, que nous cherchons pour vous ou que nous revendons pour votre compte passe le même contrôle.\nDocuments, historique, cohérence du kilométrage, points connus du modèle. Un véhicule qui résiste mal à l'examen sort de la sélection.", tagline: "Le même niveau de contrôle, quel que soit le projet." },
      { num: "04", value: "Transparence", title: "Dire les choses", description: "Le prix, notre rémunération, les frais annexes, les réserves sur un véhicule : tout est écrit avant que vous vous engagiez.\nUne réserve annoncée à temps vaut mieux qu'une vente rapide.", tagline: "Ce que nous savons, vous le savez aussi." },
      { num: "05", value: "Responsabilité", title: "Prendre en charge", description: "Négociation, contrat, paiement sécurisé, convoyage, immatriculation, garantie : nous portons ce qui vous ferait perdre du temps.\nVous gardez la main sur les décisions, nous tenons le calendrier.", tagline: "Un seul interlocuteur, du premier appel aux plaques posées." },
      { num: "06", value: "Continuité", title: "Rester présent", description: "Un conseil d'entretien, une revente à préparer, un deuxième véhicule pour la maison : vous revenez vers la même personne, celle qui connaît déjà votre dossier.\nDiscrètement, et aussi longtemps que vous le souhaitez.", tagline: "Une maison se juge sur la durée." },
    ],
    importSteps: [
