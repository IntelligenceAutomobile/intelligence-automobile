export const fr = {
  ...
  vehicleDetail: {
    ...
    reservation: {
      ...
      intro: "Laissez-nous vos coordonnées : nous vous rappelons pour bloquer le véhicule à votre nom.",
      ...
      slotHint: "Pour une heure précise, indiquez-la dans le mot ci-dessous.",
      messageLabel: "Un mot pour nous (facultatif)",
      messagePlaceholder: "Une question, une heure de rappel précise…",
      submit: "Envoyer ma demande",
      submitting: "Envoi en cours…",
      privacy: "Vos coordonnées servent uniquement à traiter cette demande.",
      successTitle: "Demande reçue",
      successBody: "Nous vous rappelons sous 24 heures ouvrées pour bloquer %v.",
      successClose: "Fermer",
      errorMsg: "L'envoi a rencontré un problème. Réessayez, ou appelez-nous au +33 6 20 24 38 79.",
      closeLabel: "Fermer",
    },
    dossierRequest: {
      title: "Recevoir le dossier complet",
      intro: "Laissez-nous vos coordonnées : nous vous envoyons le dossier complet du véhicule, photos, historique d'entretien et contrôles.",
      nameLabel: "Nom et prénom *",
      namePlaceholder: "Votre nom",
      phoneLabel: "Téléphone *",
      phonePlaceholder: "+33 6 00 00 00 00",
      ...
      messageLabel: "Un mot pour nous (facultatif)",
      messagePlaceholder: "Une question, une heure de rappel précise…",
      submit: "Recevoir le dossier",
      submitting: "Envoi en cours…",
      privacy: "Vos coordonnées servent uniquement à traiter cette demande.",
      successTitle: "Demande reçue",
      successBody: "Nous vous envoyons le dossier complet de %v sous 24 heures ouvrées.",
      successClose: "Fermer",
      errorMsg: "L'envoi a rencontré un problème. Réessayez, ou appelez-nous au +33 6 20 24 38 79.",
      closeLabel: "Fermer",
    },
