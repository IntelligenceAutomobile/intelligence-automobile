...
export const en: Translations = {
  ...
  vehicleDetail: {
    ...
    reservation: {
      ...
      intro: "Leave us your details: we will call you back to hold the vehicle in your name.",
      nameLabel: "Full name *",
      ...
      slotLabel: "Best time to call",
      slots: [
        { value: "matin", label: "Morning" },
        { value: "apres-midi", label: "Afternoon" },
        { value: "soiree", label: "Evening" },
        { value: "peu-importe", label: "Any time" },
      ],
      slotHint: "For a specific time, add it in the note below.",
      messageLabel: "A word for us (optional)",
      messagePlaceholder: "A question, a specific time to call…",
      submit: "Send my request",
      submitting: "Sending…",
      privacy: "Your details are used solely to handle this request.",
      successTitle: "Request received",
      successBody: "We will call you back within 24 business hours to hold %v.",
      successClose: "Close",
      errorMsg: "Sending ran into a problem. Try again, or call us on +33 6 20 24 38 79.",
      closeLabel: "Close",
    },
    dossierRequest: {
      title: "Receive the full file",
      intro: "Leave us your details: we will send you the vehicle's full file, photos, service history and inspections.",
      nameLabel: "Full name *",
      namePlaceholder: "Your name",
      phoneLabel: "Phone *",
      phonePlaceholder: "+33 6 00 00 00 00",
      ...
      messageLabel: "A word for us (optional)",
      messagePlaceholder: "A question, a specific time to call…",
      submit: "Receive the file",
      submitting: "Sending…",
      privacy: "Your details are used solely to handle this request.",
      successTitle: "Request received",
      successBody: "We will send you the full file for %v within 24 business hours.",
      successClose: "Close",
      errorMsg: "Sending ran into a problem. Try again, or call us on +33 6 20 24 38 79.",
      closeLabel: "Close",
    },
