// Applique à Turso la table « journal du centre de relances ».
// Table nouvelle, sans lien avec l'existant : la migration est rétro-compatible,
// le code d'avant continue de tourner avec.
// À lancer AVANT de déployer le code qui l'utilise, sinon la page Relances tombe
// en production sur « no such table: RelanceLog ».
//   npx dotenv -e .env -- node scripts/apply-migration-relance-log.mjs
...
const sqlPath = resolve(__dirname, "../prisma/migrations/20260728160000_add_relance_log/migration.sql");
