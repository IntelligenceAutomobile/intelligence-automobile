// Applique la table « PageView » (module Audience).
// Table nouvelle, sans lien avec l'existant : la migration est rétro-compatible,
// le code d'avant continue de tourner avec.
// À lancer AVANT de déployer le code qui l'utilise, sinon la page Audience tombe
// en production sur « no such table: PageView ».
//
//   node scripts/apply-migration-page-views.mjs         → Turso (production)
//   node scripts/apply-migration-page-views.mjs --dev   → dev.db (poste local)
//
...
const sqlPath = resolve(__dirname, "../prisma/migrations/20260803120000_add_page_views/migration.sql");
