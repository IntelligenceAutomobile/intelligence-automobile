// Applique à Turso la liste rouge des destinataires et le journal des emails.
// Deux tables nouvelles, sans lien avec l'existant : la migration est
// rétro-compatible, le code d'avant continue de tourner avec.
// À lancer AVANT de déployer le code qui les utilise, sinon la page Emails et le
// centre de relances tombent sur « no such table: EmailBlock ».
//   node scripts/apply-migration-email-guard.mjs
...
const sqlPath = resolve(__dirname, "../prisma/migrations/20260730100000_add_email_guard/migration.sql");
